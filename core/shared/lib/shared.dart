...
export 'src/model/response/registration_info/parent_info_base.dart';
export 'src/model/response/registration_info/parent_registration_detail.dart';
export 'src/model/response/registration_info/bank_info.dart';
...
export 'src/model/response/registration_info/base_info_detail.dart';
