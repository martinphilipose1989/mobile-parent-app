                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Visibility(
                            visible:
                                timeline.createdBy?.toLowerCase() == "system",
                            replacement: SvgPicture.asset(AppImages.userIcon),
                            child: SvgPicture.asset(AppImages.instagramIcon),
                          ),
                          // const Icon(
                      ...
                      CommonText(
                        text: DateFormat('dd/MM/yyyy hh:mm a').format(
                            DateTime.parse(timeline.createdAt ?? '').toLocal()),
                        style: AppTypography.body2
