      ...
      child: Column(
        ...
        children: [
          ...
          CommonTextFormField(
            ...
            validator: (value) =>
                AppValidators.validateNotEmpty(value, "Student first name"),
          ),
          const SizedBox(
            height: 20,
          ),
          CommonTextFormField(
            ...
            validator: (value) =>
                AppValidators.validateNotEmpty(value, "Student last name"),
          ),
          const SizedBox(
            height: 20,
          ),
                  ...
                  return CustomDropdownButton(
                    ...
                    onSingleSelect: (selectedValue) {
                      if (model.gradeTypes.value.contains(selectedValue)) {
                        var grade = model.gradeTypesAttribute?.firstWhere(
                    ...
                    isMutiSelect: false,
                    validator: (value) =>
                        AppValidators.validateDropdown(value, "grade"),
                  );
                }
              }),
          const SizedBox(
                  ...
                  return CustomDropdownButton(
                    ...
                    onSingleSelect: (selectedValue) {
                      if (model.gender.value.contains(selectedValue)) {
                        var gender = model.genderAttribute?.firstWhere(
                            (element) => (element.attributes?.name ?? '')
                                .contains(selectedValue));
                    ...
                    isMutiSelect: false,
                    validator: (value) =>
                        AppValidators.validateDropdown(value, "gender"),
                  );
                }
              }),
          const SizedBox(
                  ...
                  return CustomDropdownButton(
                    ...
                    onSingleSelect: (selectedValue) {
                      if (model.existingSchoolBoard.value
                        ...
                        model.selectedExistingSchoolBoardEntity?.value =
                  ...
                  return CustomDropdownButton(
                    ...
                    onSingleSelect: (selectedValue) {
                      if (model.existingSchoolGrade.value
                        ...
                        model.selectedExistingSchoolGradeEntity?.value =
                            grade?.attributes?.name;
                      }
                    },
                    isMutiSelect: false,
          ...
          CustomDropdownButton(
            ...
            isMutiSelect: false,
            validator: (value) =>
                AppValidators.validateDropdown(value, 'parent type'),
          ),
          const SizedBox(
            height: 20,
          ),
