...
class EnquiryAndStudentEditing extends StatelessWidget {
  ...
  const EnquiryAndStudentEditing(
      {super.key, required this.model, required this.enquiryDetailArgs});
                  ...
                  child: Column(
                    children: [
                              ...
                              return CustomDropdownButton(
                                ...
                                onSingleSelect: (selectedValue) {
                                  if (model.gradeTypes.value
                                    ...
                                    model.selectedGradeEntity?.value =
                                        grade?.attributes?.name;
                                  }
                                },
                                singleSelectItemSubject:
                                    model.selectedGradeSubject,
                                isMutiSelect: false,
                                validator: (value) =>
                              ...
                              return CustomDropdownButton(
                                ...
                                onSingleSelect: (selectedValue) {
                                  if (model.gender.value
                                    ...
                                    model.selectedGenderEntity?.value =
                          ...
                          builder: (context, snapshot) {
                            if (!snapshot.hasData) {
                              ...
                              return CustomDropdownButton(
                                ...
                                items: snapshot.data ?? [],
                                singleSelectItemSubject:
                                    model.selectedExistingSchoolBoardSubject,
                                onSingleSelect: (selectedValue) {
                                  if (model.existingSchoolBoard.value
                                      .contains(selectedValue)) {
                                    var board = model
                                        .existingSchoolBoardAttribute
                                        ?.firstWhere((element) =>
                                            (element.attributes?.name ?? '')
                                                .contains(selectedValue));
                          ...
                          builder: (context, snapshot) {
                            if (!snapshot.hasData) {
                              ...
                              return CustomDropdownButton(
                                ...
                                items: snapshot.data ?? [],
                                singleSelectItemSubject:
                                    model.selectedExistingSchoolGradeSubject,
                                onSingleSelect: (selectedValue) {
                                  if (model.existingSchoolGrade.value
                                      .contains(selectedValue)) {
                                    var grade = model.gradeTypesAttribute
                                        ?.firstWhere((element) =>
                                            (element.attributes?.name ?? '')
                      ...
                      CustomDropdownButton(
                        ...
                        singleSelectItemSubject:
                            model.selectedParentTypeSubject,
                        onSingleSelect: (selectedValue) {
                          ...
                          builder: (context, snapshot) {
                            if (!snapshot.hasData) {
                              ...
                              return CustomDropdownButton(
                                ...
                                onSingleSelect: (selectedValue) {
                                  if (model.religions.value
                                      .contains(selectedValue)) {
                                    var religion = model.religionAttribute
                                        ?.firstWhere((element) =>
                                            (element.attributes?.name ?? '')
                                                .contains(selectedValue));
                          ...
                          builder: (context, snapshot) {
                            if (!snapshot.hasData) {
                              ...
                              return CustomDropdownButton(
                                ...
                                onSingleSelect: (selectedValue) {
                                  if (model.castes.value
                                      .contains(selectedValue)) {
                                    var caste = model.casteAttribute
                                        ?.firstWhere((element) =>
                                            (element.attributes?.name ?? '')
                                                .contains(selectedValue));
                          ...
                          builder: (context, snapshot) {
                            if (!snapshot.hasData) {
                              ...
                              return CustomDropdownButton(
                                ...
                                onSingleSelect: (selectedValue) {
                                  if (model.subCastes.value
                                      .contains(selectedValue)) {
                                    var subCaste = model.subCasteAttribute
                                        ?.firstWhere((element) =>
                                            (element.attributes?.name ?? '')
                                                .contains(selectedValue));
                          ...
                          builder: (context, snapshot) {
                            if (!snapshot.hasData) {
                              ...
                              return CustomDropdownButton(
                                ...
                                onSingleSelect: (selectedValue) {
                                  if (model.motherTongues.value
                                      .contains(selectedValue)) {
                                    var board = model.motherTongueAttribute
                                        ?.firstWhere((element) =>
                                            (element.attributes?.name ?? '')
                                                .contains(selectedValue));
                ...
                return CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    if (model.psaSubType.value.contains(selectedValue)) {
                      var psaSubType = model.psaSubTypeAttribute?.firstWhere(
                          (element) => (element.attributes?.name ?? '')
                              .contains(selectedValue));
                      model.selectedPsaSubType.add(true);
                      model.selectedPsaSubTypeEntity?.id = psaSubType?.id;
                      model.selectedPsaSubTypeEntity?.value =
                          psaSubType?.attributes?.name;
                    }
                  },
                  isMutiSelect: false,
                  validator: (value) =>
                      AppValidators.validateDropdown(value, 'PSA sub type'),
                );
              }
            }),
        const SizedBox(
                ...
                return CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    if (model.psaCategory.value.contains(selectedValue)) {
                      var psaCategory = model.psaCategoryAttribute?.firstWhere(
                          (element) => (element.attributes?.name ?? '')
                              .contains(selectedValue));
                      model.selectedPsaCategory.add(true);
                      model.selectedPsaCategoryEntity?.id = psaCategory?.id;
                      model.selectedPsaCategoryEntity?.value =
                          psaCategory?.attributes?.name;
                    }
                  },
                  isMutiSelect: false,
                  validator: (value) =>
                      AppValidators.validateDropdown(value, 'PSA category'),
                );
              }
            }),
        const SizedBox(
                ...
                return CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    if (model.psaSubCategory.value.contains(selectedValue)) {
                      var psaSubCategory = model.psaSubCategoryAttribute
                          ?.firstWhere((element) =>
                              (element.attributes?.name ?? '')
                                  .contains(selectedValue));
                      model.selectedPsaSubCategory.add(true);
                      model.selectedPsaSubCategoryEntity?.id =
                          psaSubCategory?.id;
                      model.selectedPsaSubCategoryEntity?.value =
                          psaSubCategory?.attributes?.name;
                    }
                  },
                  isMutiSelect: false,
                  validator: (value) =>
                      AppValidators.validateDropdown(value, 'PSA sub category'),
                );
              }
            }),
        const SizedBox(
                ...
                return CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    if (model.periodOfService.value.contains(selectedValue)) {
                      var periodOfService = model.periodOfServiceAttribute
                          ?.firstWhere((element) =>
                              (element.attributes?.name ?? '')
                                  .contains(selectedValue));
                      model.selectedPeriodOfService.add(true);
                      model.selectedPeriodOfServiceEntity?.id =
                          periodOfService?.id;
                      model.selectedPeriodOfServiceEntity?.value =
                          periodOfService?.attributes?.name;
                    }
                  },
                  isMutiSelect: false,
                  validator: (value) => AppValidators.validateDropdown(
                      value, 'period of service'),
                );
              }
            }),
        const SizedBox(
                ...
                return CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    if (model.psaBatch.value.contains(selectedValue)) {
                      var psaBatch = model.psaBatchAttribute?.firstWhere(
                          (element) => (element.attributes?.name ?? '')
                              .contains(selectedValue));
                      model.selectedPsaBatch.add(true);
                      model.selectedPsaBatchEntity?.id = psaBatch?.id;
                      model.selectedPsaBatchEntity?.value =
                          psaBatch?.attributes?.name;
                    }
                  },
                  isMutiSelect: false,
                  validator: (value) =>
                      AppValidators.validateDropdown(value, 'PSA batch'),
                );
              }
            }),
      ],
              ...
              if (!snapshot.hasData) {
                ...
                return CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    if (model.existingSchoolBoard.value
                        .contains(selectedValue)) {
                      var board = model.existingSchoolBoardAttribute
                          ?.firstWhere((element) =>
                              (element.attributes?.name ?? '')
                                  .contains(selectedValue));
                      model.selecteBoard.add(true);
                      model.selectedBoardEntity?.id = board?.id;
                      model.selectedBoardEntity?.value =
                          board?.attributes?.name;
                    }
                  },
                  isMutiSelect: false,
                  validator: (value) =>
                      AppValidators.validateDropdown(value, 'board'),
                );
              }
            }),
        const SizedBox(
                ...
                return CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    if (model.course.value.contains(selectedValue)) {
                      var course = model.courseTypeAttribute?.firstWhere(
                          (element) => (element.attributes?.name ?? '')
                              .contains(selectedValue));
                      model.selectedCourse.add(true);
                      model.selectedCourseEntity?.id = course?.id;
                      model.selectedCourseEntity?.value =
                          course?.attributes?.name;
                    }
                  },
                  isMutiSelect: false,
                  validator: (value) =>
                      AppValidators.validateDropdown(value, 'course'),
                );
              }
            }),
        const SizedBox(
                ...
                return CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    if (model.stream.value.contains(selectedValue)) {
                      var stream = model.streamTypeAttribute?.firstWhere(
                          (element) => (element.attributes?.name ?? '')
                              .contains(selectedValue));
                      model.selectedStream.add(true);
                      model.selectedStreamEntity?.id = stream?.id;
                      model.selectedStreamEntity?.value =
                          stream?.attributes?.name;
                    }
                  },
                  isMutiSelect: false,
                  validator: (value) =>
                      AppValidators.validateDropdown(value, 'stream'),
                );
              }
            }),
        const SizedBox(
                ...
                return CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    if (model.shift.value.contains(selectedValue)) {
                      var board = model.shiftTypeAttribute?.firstWhere(
                          (element) => (element.attributes?.name ?? '')
                              .contains(selectedValue));
                      model.selectedShift.add(true);
                      model.selectedShiftEntity?.id = board?.id;
                      model.selectedShiftEntity?.value =
                          board?.attributes?.name;
                    }
                  },
                  isMutiSelect: false,
                  validator: (value) =>
                      AppValidators.validateDropdown(value, 'shift'),
                );
              }
            }),
      ],
