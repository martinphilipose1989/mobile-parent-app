  ...
  Widget build(BuildContext context) {
    ...
    return Column(
          children: [
            ...
            DetailsItem(title: "Existing School Name", subtitle: psaDetail?.existingSchoolDetails?.name?.value??''),
    ...
    return Column(
          children: [
           DetailsItem(title: "Enquiry Number", subtitle: enquiryDetailArgs?.enquiryNumber??''),
            ...
            DetailsItem(title: "Existing School Name", subtitle: newAdmissionDetail?.existingSchoolDetails?.name?.value??''),
  ...
  Widget getIvtDetails({IVTDetail? ivtDetail}){
    return Column(
          children: [
            ...
            DetailsItem(title: "Existing School Name", subtitle: ivtDetail?.existingSchoolDetails?.name?.value??''),
