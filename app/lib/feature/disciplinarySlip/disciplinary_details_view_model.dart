...
class DisplinaryDetailsViewModel extends BasePageViewModel {
  ...
  DisplinaryDetailsViewModel(
      ...
      this.disciplinarySlipListUsecase,
      this.createAcknowledgementUsecase,
      this.coReasonsListUsecase,
      this.studentDetailUsecase);

  BehaviorSubject<bool> showExpansion = BehaviorSubject<bool>.seeded(false);
  ...
  void acknowledgeSlip({required AcknowlegementRequestModel model}) {
    exceptionHandlerBinder.handle(block: () {
      CreateAcknowledgementUsecaseParams params =
          CreateAcknowledgementUsecaseParams(model);
  ...
  void getSlipList(
    ...
    exceptionHandlerBinder.handle(block: () {
      DisciplinarySlipListUsecaseParams params =
          DisciplinarySlipListUsecaseParams(studentId: studentId);
