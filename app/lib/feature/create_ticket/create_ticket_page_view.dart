  ...
  Widget build(BuildContext context, CreateTicketViewModel model) {
    return Padding(
      ...
      /*  AppStreamBuilder<bool>(
            stream: model.loadingIndicator,
            initialData: model.loadingIndicator.value,
             ...
             const Center(
              ...
              children: [
                 AppStreamBuilder<Resource<List<MsgCategoryModelDatum>>>(
                        ...
                        items: data?.data?.map((e) => e.attributes!.name).toList() ??
                            [], //model.categoryTypes
            ...
            dataBuilder: (context, data) {
              return SizedBox(
                ...
                child: CustomDropdownButton(
                  ...
                  onSingleSelect: (selectedValue) {
                    print('selected sub category ${selectedValue}');
