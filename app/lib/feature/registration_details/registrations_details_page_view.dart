...
class RegistrationsDetailsPageView
                ...
                child: Column(
                  ...
                  children: [
                    ListItem(
                      ...
                      compeletion:
                          enquiryDetailArgs?.formCompletionPercentage == null
                              ? ''
                              : (enquiryDetailArgs?.formCompletionPercentage ??
                                      0)
                                  .toString(),
                    ),
  ...
  Widget registrationsEditingWidgetAsPerIndex(
    ...
    switch (index) {
      case 0:
        return EnquiryAndStudentEditing(
          model: model,
          enquiryDetailArgs: enquiryDetailArgs ?? EnquiryDetailArgs(),
        );
      case 1:
        ...
        return AppStreamBuilder<Resource<IVTDetail>>(
            ...
            dataBuilder: (context, result) {
              switch (result?.status) {
                ...
                case Status.success:
                  return EnquiryAndStudentDetails(
                      enquiryDetailArgs: enquiryDetailArgs,
