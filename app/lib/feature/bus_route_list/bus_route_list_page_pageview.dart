...
class BusRouteListPageView
  ...
  void navigateToBusRouteDetails({required BuildContext context,
  ...
  Widget _studentDetailsBottomWidget(BusRouteListPageViewModel model) {
    ...
    return AppStreamBuilder<Resource<GetStudentAttendance>>(
        ...
        dataBuilder: (context, snapshot) {
          var attendanceList = snapshot?.data?.data?.attendanceList ?? [];
          ...
          return StudentDetailsRowWidget(
              ...
              desc: attendanceListItem?.attendanceType ?? "attendanceType",
              status:
              attendanceListItem?.attendanceRemark ?? "attendanceRemark",
