...
class SummerCampEnrollmentDetailEntity extends BaseLayerDataTransformer<
    SummerCampEnrollmentDetailEntity, SummerCampEnrollmentDetailModel> {
  ...
  factory SummerCampEnrollmentDetailEntity.fromJson(
          Map<String, dynamic> json) =>
      _$SummerCampEnrollmentDetailEntityFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SummerCampEnrollmentDetailEntityToJson(this);
  ...
  SummerCampEnrollmentDetailModel transform() {
    return SummerCampEnrollmentDetailModel(
        ...
        feesCategory: feeCategory?.map((e) => e.transform()).toList());
  }
}
