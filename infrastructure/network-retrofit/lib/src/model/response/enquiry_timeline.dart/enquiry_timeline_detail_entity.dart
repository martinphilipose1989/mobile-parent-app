...
class EnquiryTimelineDetailEntity extends BaseLayerDataTransformer<
    EnquiryTimelineDetailEntity, EnquiryTimelineDetail> {
  @JsonKey(name: '_id')
  String? id;
  ...
  EnquiryTimelineDetail transform() {
    ...
    enquiryTimelineDetail.createdBy = createdBy;
