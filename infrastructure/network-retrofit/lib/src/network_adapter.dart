...
class NetworkAdapter implements NetworkPort {
  ...
  @override
  Future<Either<NetworkError,SiblingProfileResponse>> getSiblingDetail({required GetSiblingDetailRequest getSiblingDetailRequest}) async{
    var response = await safeApiCall(apiService.getSiblingDetail(getSiblingDetailRequest: getSiblingDetailRequest));
    return response.fold((l) {
      return Left(l);
    }, (r) => Right(r.data.transform()));
  } 
